...
import com.appperfektion.simpleweatherapp.ui.theme.BlueJC
import com.appperfektion.simpleweatherapp.ui.theme.DarkBlueJC
import com.appperfektion.simpleweatherapp.ui.theme.SimpleWeatherAppTheme
...
fun WeatherScreen(){
    ...
    val apiKey = "7da2f39a1dd1da4c66858946cfd288a4"
    ...
    Box(modifier = Modifier
        ...
        Column(modifier = Modifier
            ...
            Text(text = "Weather", fontSize = 30.sp, fontWeight = FontWeight.SemiBold, color = BlueJC,
            ...
            Spacer(modifier = Modifier.height(16.dp))
            //if weatherData not null then do...
            weatherData?.let {
                //create cards in row
                Row(modifier = Modifier.fillMaxWidth(),
                    ...
                    WeatherCard(label = "Temparature", value = "${it.main.temp}°C", icon = Icons.Default.Star)
                }
                Row(modifier = Modifier.fillMaxWidth(),
                    horizontalArrangement = Arrangement.SpaceEvenly
                ) {
...
@Composable
fun WeatherCard(label: String, value: String, icon: ImageVector){ //label = title text, value = response from API
